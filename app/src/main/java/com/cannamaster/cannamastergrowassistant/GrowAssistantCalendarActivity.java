...
public class GrowAssistantCalendarActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        // set the layout file to pull from
        setContentView(R.layout.grow_assistant_test_layout);
    ...
    private void addToDeviceCalendar(String startDate,String endDate, String title,String description, String location, int reminder) {
        ...
        try {
            ...
            /********************************************************************************************
             * This next section is relating to adding the event variables within the calendar database
             ********************************************************************************************/
    ...
    /*******************************************************
     * This grabs the info from the text boxes and zips them into the string for insertion into
     * a new calendar event. todo : this is going to have to be converted into a date picker layout
     ********************************************************/
